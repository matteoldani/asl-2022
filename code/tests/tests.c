...
int main(int argc, char const *argv[]) {
    ...
    int n_mmulrtrans_opt = 0; //BACK 17
    int n_mmulltrans_opt = 0;
    int n_mmul_opt = 0; //BACK 17
    int n_nnm_opt = 4; //BACK 17
   ...
   /* mmul[0] = matrix_mul_bs1;
    ...
    nnmd[1] = nnm_factorization_opt34;
    nnmd[2] = nnm_factorization_opt35;
    nnmd[3] = nnm_factorization_opt36;
