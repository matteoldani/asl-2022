 ...
 */
void matrix_mul_opt45(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row, int R_n_col)
{   //printf("\n\nStart mult\n");
...
inline double error(double* approx, double* V, double* W, double* H, int m, int n, int r, int mn, double norm_V) {
    ...
    matrix_mul_opt45(W, m, r, H, r, n, approx, m, n);
 ...
 */
double nnm_factorization_opt45(double *V, double*W, double*H, int m, int n, int r, int maxIteration, double epsilon) {
    ...
    for (int count = 0; count < maxIteration; count++) {
        ...
        transpose(W, Wt, m, r);
        matrix_mul_opt45(Wt, r, m, V, m, n, numerator, r, n);
        matrix_mul_opt45(Wt, r, m, W, m, r, denominator_l, r, r);
        // matrix_ltrans_mul_opt24(W, m, r, V, m, n, numerator, r, n);
        // matrix_ltrans_mul_opt24(W, m, r, W, m, r, denominator_l, r, r);
        matrix_mul_opt45(denominator_l, r, r, H, r, n, denominator, r, n);
        ...
        matrix_mul_opt45(W, m, r, denominator_l, r, r, denominator_W, m, r);
