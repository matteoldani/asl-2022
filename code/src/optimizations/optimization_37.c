...
//NEW - Optimization done on top of opt_47 - Added vectorized and generalized transpose function

static unsigned int double_size = sizeof(double);

//NEW - Helper function that transposes a small 4x4 block
 ...
 */
void matrix_mul_opt37_padding(double *A_final, int A_n_row, int A_n_col, double *B_final, int B_n_row, int B_n_col,
    ...
    matrix_mul_opt37(W, m, r, H, r, m, V, m, n);
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_mul_opt37(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
 ...
 */
double nnm_factorization_opt37(double *V_final, double *W_final, double *H_final, int m, int n, int r, int maxIteration,
                               double epsilon) {
    ...
    for (int count = 0; count < maxIteration; count++) {
        ...
        transpose(W, Wt, m, r);
        matrix_mul_opt37(Wt, r, m, V, m, n, numerator, r, n);
        matrix_mul_opt37(Wt, r, m, W, m, r, denominator_l, r, r);
        matrix_mul_opt37(denominator_l, r, r, H, r, n, denominator, r, n);
        ...
        transpose(H, Ht, r, n);
        matrix_mul_opt37(V, m, n, Ht, n, r, numerator_W, m, r);
        matrix_mul_opt37(H, r, n, Ht, n, r, denominator_l, r, r);
        matrix_mul_opt37(W, m, r, denominator_l, r, r, denominator_W, m, r);
