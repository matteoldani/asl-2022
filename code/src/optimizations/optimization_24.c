 ...
 */
void matrix_mul_opt24(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
    //NEW blas used
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_ltrans_mul_opt24(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R,
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_rtrans_mul_opt24(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R,
                             int R_n_row, int R_n_col) {
    //NEW blas used
