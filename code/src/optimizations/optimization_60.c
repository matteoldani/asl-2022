...
// NEW on top of optimization 47 - introduces a new way of calculating the error function
 ...
 */
void matrix_mul_opt60(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
    ...
    for (i = 0; i < m - nB + 1; i += nB) {
        for (j = 0; j < n - nB + 1; j += nB) {
            ...
            for (int is = 0; is < nB; is++) {
                ...
                v1 = _mm256_load_pd((double *) &V[Rii + 4]);
                v2 = _mm256_load_pd((double *) &V[Rii + 8]);
                v3 = _mm256_load_pd((double *) &V[Rii + 12]);

                t0 = _mm256_sub_pd(r0, v0);
                t1 = _mm256_sub_pd(r1, v1);
 ...
 */
double nnm_factorization_opt60(double *V_final, double *W_final, double *H_final, int m, int n, int r, int maxIteration,
                               double epsilon) {
    ...
    for (int count = 0; count < maxIteration; count++) {
        ...
        transpose(W, Wt, m, r);
        matrix_mul_opt60(Wt, r, m, V, m, n, numerator, r, n);
        matrix_mul_opt60(Wt, r, m, W, m, r, denominator_l, r, r);
        matrix_mul_opt60(denominator_l, r, r, H, r, n, denominator, r, n);
        ...
        transpose(H, Ht, r, n);
        matrix_mul_opt60(V, m, n, Ht, n, r, numerator_W, m, r);
        matrix_mul_opt60(H, r, n, Ht, n, r, denominator_l, r, r);
        matrix_mul_opt60(W, m, r, denominator_l, r, r, denominator_W, m, r);
