 ...
 */
void matrix_mul_opt32(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_rtrans_mul_opt32(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R,
 ...
 */
double
nnm_factorization_opt32(double *V_rowM, double *W, double *H, int m, int n, int r, int maxIteration, double epsilon) {
    double *Wt;
