 ...
 */
void matrix_mul_opt61_padding(double *A_final, int A_n_row, int A_n_col, double *B_final, int B_n_row, int B_n_col,
    ...
    matrix_mul_opt61(W, m, r, H, r, m, V, m, n);
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_mul_opt61(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
 ...
 */
double nnm_factorization_opt61(double *V_final, double *W_final, double *H_final, int m, int n, int r, int maxIteration,
                               double epsilon) {
    ...
    transpose(W, Wt, m, r);
    matrix_mul_opt61(Wt, r, m, V, m, n, numerator, r, n);
    matrix_mul_opt61(Wt, r, m, W, m, r, denominator_l, r, r);
    ...
    for (int count = 0; count < maxIteration; count++) {
        ...
        matrix_mul_opt61(denominator_l, r, r, H, r, n, denominator, r, n);
