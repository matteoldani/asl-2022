 ...
 */
void matrix_mul_opt12(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R, int R_n_row,
                      int R_n_col) {
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_ltrans_mul_opt12(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R,
 ...
 * @param R_n_col   is the number of columns in the result
 */
void matrix_rtrans_mul_opt12(double *A, int A_n_row, int A_n_col, double *B, int B_n_row, int B_n_col, double *R,
                             int R_n_row, int R_n_col) {
...
inline double error(double *approx, double *V, double *W, double *H, int m, int n, int r, int mn, double norm_V) {
    ...
    matrix_mul_opt12(W, m, r, H, r, n, approx, m, n);
...
double nnm_factorization_opt12(double *V, double *W, double *H, int m, int n, int r, int maxIteration, double epsilon) {
    ...
    for (int count = 0; count < maxIteration; count++) {
        ...
        // NEW Added transposition before matrix multiplication
        transpose(W, W_trans, m, r);
        ...
        matrix_rtrans_mul_opt12(V, m, n, H, r, n, numerator_W, m, r);
        matrix_rtrans_mul_opt12(H, r, n, H, r, n, denominator_l, r, r);
        matrix_mul_opt12(W, m, r, denominator_l, r, r, denominator_W, m, r);
