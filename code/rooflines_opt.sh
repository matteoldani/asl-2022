...
advixe-cl -collect survey -project-dir ./advi_results -- taskset -c 24 800 800 16
advixe-cl -collect tripcounts -flop -stacks -project-dir ./advi_results -- taskset -c 1  ./build/optimisations 24 800 800 16
