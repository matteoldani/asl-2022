...
evaluations = {25: 'opt47'}

for rank in ranks:
    for evaluation in evaluations:
        os.system(f'/home/asl/asl-2022/code/build/performance {evaluation} 200 1800 25 /home/asl/asl-2022/docs/outputs/3D/opt47/{evaluations[evaluation]}_r{rank}.out {rank}')
        time.sleep(1)
